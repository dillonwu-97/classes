public class TestAthletesAnswer {
...
abstract class Athlete {
    ...
    public String getType(String raceName) {
        ...
        if (found == -1) {
            return null;
        } else  if ("road".equals(raceLocations[found]) || "trail".equals(raceLocations[found])) {
            return "run";
        } else if ("pool".equals(raceLocations[found]) || "lake".equals(raceLocations[found])) {
            return "swim";
        } else {
            return "unknown";
        }
    ...
    public String[] getRaces() {
        String[] races = new String[numRaces];
        for (int i = 0; i < numRaces; i++) {
            races[i] = raceNames[i] + " at " + raceLocations[i];
        }
        return races;
    }
...
class Marathoner extends Athlete implements Runner {
    ...
    public String toString() {
        return "My name is " + name + " and I am a Marathoner. I completed " + completedRuns + " runs.";
    }
    ...
    public boolean compete(String raceName) {
        String raceType = getType(raceName);
        if ("run".equals(raceType)) {
            System.out.println(run(raceName, getLocation(raceName)));
            completedRuns++;
...
class Triathlete extends Athlete implements Runner, Swimmer {
    ...
    public String toString() {
        return "My name is " + name + " and I am a Triathlete. I completed " + completedRuns + " runs and " + completedSwims + " swims.";
    }
    ...
    public boolean compete(String raceName) {
        ...
        if ("run".equals(raceType)) {
            ...
            System.out.println("I completed the run " + raceName);
            return true;
        } else if ("swim".equals(raceType)) {
            System.out.println(swim(raceName, getLocation(raceName)));
            completedSwims++;
